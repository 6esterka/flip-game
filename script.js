...
function shuffleCards(){
    ...
    let arr=["bxs-coffee-bean","bxs-cheese","bxs-hard-hat","bxs-invader","bxs-angry","bx-male-female","bxs-coffee-bean","bxs-cheese","bxs-hard-hat","bxs-invader","bx-male-female","bxs-angry"];
